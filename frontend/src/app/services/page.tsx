...
export const metadata = createMetadata({
  title: 'Services',
  description:
    'Estimating, architectural drawings, MEP engineering, structural engineering, 3D visualization, and property acquisitions — all under one roof.',
  path: '/services',
});
    ...
    <>
      ...
      <section className="band">
        <div className="wrap stack-lg">
          ...
          <div className="note">
            <b>Markets we serve.</b> Residential, commercial, industrial, government &amp; public, infrastructure &amp; civil, and hospitality &amp; recreation — see{' '}
            <Link href="/markets">Markets &amp; Sectors</Link>. For trade-by-trade estimation pages, open{' '}
            <Link href="/estimation">Estimation</Link>.
          </div>
        </div>
      </section>
      <CTA title="Start with the decision in front of you" text="Send the plans, property information, or scope you are working through and we will help define the next step." />
    </>
  );
}
