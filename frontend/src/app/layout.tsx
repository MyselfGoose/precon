...
export const metadata: Metadata = { title:'PreCon Ext | Preconstruction intelligence', description:'Integrated estimating, drafting, engineering, coordination, and acquisition support for teams moving projects from concept to construction.' };
