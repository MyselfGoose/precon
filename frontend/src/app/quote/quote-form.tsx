...
export default function QuoteForm() {
  ...
  if (sent) return <div className="success-card" role="status" aria-live="polite"><div className="ico" aria-hidden="true">✓</div><h2>Your project brief is ready.</h2><p>Your information has been prepared in this browser, but no message or file has been sent yet. Keep this brief available for your project conversation. For urgent questions, call <a href="tel:+18005550100">{BRAND.phone}</a>.</p><Link className="btn btn-primary" href="/">Back to home</Link></div>;
