...
{ slug:'concrete', art:'a', noun:'concrete', div:'03', name:'Concrete', short:'Footings, slabs, walls, formwork, rebar, finishes',
  lede:'Cast-in-place concrete quantities and pricing measured from your structural set, reported in the units your ready-mix supplier, rebar fabricator and finishing crew quote in.',
  intro:['A concrete takeoff is only as good as its separation of scope. We break every pour into its own line: footings, walls, piers, slabs on grade, elevated decks, and toppings. Formwork, reinforcing, placement, finishing and curing are carried as separate items so labor and material can be priced independently and swapped for your own rates.',
  ...
  sample:{title:'Warehouse shell, 18,650 SF',cols:['Description','Qty','Unit','Sheet','Material','Labor','Total'],rows:[
    ['Continuous footings, 24"x12"','1,240','LF','S-101','18,600','14,880','33,480'],['Foundation walls, 8" CIP','3,420','SF','S-102','27,360','30,780','58,140'],['Wall formwork, two sides','6,840','SFCA','S-102','10,260','27,360','37,620'],['Slab on grade, 5" w/ 6x6 WWF','18,650','SF','S-103','74,600','46,625','121,225'],['Reinforcing steel, #5, laps incl.','24,800','LB','S-105','22,320','14,880','37,200'],['Placement, finish & cure','742','CY','-','-','51,940','51,940']],
...
{ slug:'masonry', art:'a', noun:'masonry', div:'04', name:'Masonry', short:'CMU, brick veneer, mortar, grout, reinforcing, lintels',
  lede:'Unit masonry takeoffs for CMU, brick and stone, counted by the unit and reported by the square foot. Grout, mortar, reinforcing and accessories are carried separately.',
...
{ slug:'metals', art:'a', noun:'structural steel', div:'05', name:'Metals', short:'Structural steel, joists, metal deck, misc. metals, railings',
  ...
  sample:{title:'Single-story warehouse, 66,000 SF',cols:['Description','Qty','Unit','Sheet','Material','Labor','Total'],rows:[
    ['W10x33 columns, 22\', 12 EA','4.4','TON','S-601','12,320','4,400','16,720'],['W16x31 beams, 30\', 24 EA','11.2','TON','S-201','31,360','11,200','42,560'],['24K7 joists @ 5\'-0", 132 EA','3,960','LF','S-201','43,560','19,800','63,360'],['1.5" Type B roof deck, 20 ga','66,000','SF','S-201','118,800','59,400','178,200'],['Connections, 12% of weight','1.9','TON','-','7,600','-','7,600'],['Erection, crane, crew, 8 days','19.5','TON','-','-','27,300','27,300']],
...
{ slug:'wood', art:'a', noun:'wood framing', div:'06', name:'Wood & Plastics', short:'Framing, sheathing, engineered lumber, trusses, millwork',
  ...
  sample:{title:'Two-story wood-frame office, 9,600 SF',cols:['Description','Qty','Unit','Sheet','Material','Labor','Total'],rows:[
    ['2x6 studs @ 16" O.C., 9\'-1-1/8"','1,480','EA','S-201','13,320','11,840','25,160'],['Plates, headers, blocking, 2x material','9,800','BF','S-201','9,310','5,880','15,190'],['11⅞" I-joists @ 16" O.C.','4,320','LF','S-202','15,120','8,640','23,760'],['7/16" OSB wall sheathing','8,900','SF','A-301','6,230','4,450','10,680'],['Roof trusses, 32\' span, 4:12','62','EA','S-203','24,800','9,300','34,100'],['Hangers, straps, hold-downs, fasteners','1','LS','S-501','5,400','2,700','8,100']],
...
{ slug:'hvac', art:'an', noun:'HVAC', div:'23', name:'HVAC', short:'Equipment, ductwork, piping, insulation, controls, TAB',
  ...
  intro:['HVAC pricing lives in the ductwork and the equipment schedule. We count every unit on the schedule by tag, then measure ductwork by size and gauge and convert to pounds of sheet metal, the way fabrication shops price it, while also reporting linear feet so field labor can be checked.',
...
{ slug:'electrical', art:'an', noun:'electrical', div:'26', name:'Electrical', short:'Service, distribution, feeders, branch, devices, lighting',
  ...
  sample:{title:'Single-story retail, 18,650 SF',cols:['Description','Qty','Unit','Sheet','Material','Labor','Total'],rows:[
    ['400A 208Y/120V service, CT cabinet, MDP','1','LS','E-501','28,000','9,600','37,600'],['Feeders, 4#3 to 4#500 kcmil, EMT/PVC','1,120','LF','E-501','22,400','16,800','39,200'],['Panelboards LP-1/2/3, 75 kVA xfmr','4','EA','E-502','18,400','6,400','24,800'],['Branch circuits, 3/4" EMT + #12 THHN','9,600','LF','E-201','19,200','43,200','62,400'],['Devices: recept., switches, sensors, 214 EA','214','EA','E-201','6,420','12,840','19,260'],['Lighting: 2x4 LED troffers, EM, exit, 148 EA','148','EA','E-601','37,000','17,760','54,760']],
...
{ slug:'utilities', art:'a', noun:'site utility', div:'33', name:'Utilities', short:'Site water, sanitary, storm, gas, electrical duct bank, structures',
  lede:'Site utility takeoffs from civil plans and profiles: pipe by size, material and depth, structures by the each. Trenching, bedding, backfill, connections and testing are carried separately.',
